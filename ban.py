...
class SimpleBanResponderMod(loader.Module):
    ...
    strings = {
        ...
        "response_message": "Личное общение не приветствуется. Personal communication is not encouraged."
    }

    def __init__(self):
        self.config = loader.ModuleConfig(
            "whitelist", [
                263857209, 6258382063, 831408739, 1628112862, 1512882126, 1905781428, 
