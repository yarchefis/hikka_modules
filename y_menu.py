...
class yMenuMod(loader.Module):
    ...
    strings = {
        "name": "yMenu",
        "config_response": f"Держи конфиг. Обрати внимание это автоматическое сообщение. Если у тебя есть вопрос, просто напиши его.\n {meta_message} <emoji document_id=5274196681024348149>😊</emoji>",
