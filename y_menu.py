...
class yMenuMod(loader.Module):
    ...
    strings = {
        "name": "yMenu",
        "config_response": "Держи конфиг. Обрати внимание это автоматическое сообщение.</emoji>",
        ...
        "not_delivered": 'Ваше сообщение не доставлено! Если вы хотите/хотели задать вопрос пожалуйста напишите его <a href="http://t.me/yarchefis_hikka_bot?start=feedback">боту</a> но перед этим Изучи: http://nometa.xyz',
    ...
    whitelist = [123456789, 987654321]  # Замените на реальные ID пользователей, которых нужно добавить в whitelist
